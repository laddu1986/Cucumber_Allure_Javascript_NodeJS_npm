  ...
  //  services: ['iedriver'],
    ...
    //tagExpression: '@home',
      ...
      //   strict: true
        ...
        tagExpression: 'not @review',//not @Pending',//'not @Pending',      // <string> (expression) only execute the features or scenarios with tags matching the expression, see https://docs.cucumber.io/tag-expressions/
